...
Package: `lms-hostinger-staging-20260702-f986daa`
Build source: current working tree built from git short SHA `f986daa`.

This package includes the latest LMS frontend bundle, including the recent Student Resources paid-card UX and Admin Students multi-cohort/program assignment improvements.
