...
Package: `lms-hostinger-staging-20260704-recording-lifecycle-announcement-tabs.zip`
...
- Announcement tab layout fix:
  - Create Announcement and History match Support tabs.
  - Tabs cover the full page width and labels are centered.
