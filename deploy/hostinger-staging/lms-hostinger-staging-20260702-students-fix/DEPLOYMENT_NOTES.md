...
Package: `lms-hostinger-staging-20260702-students-fix`

Use this package instead of `lms-hostinger-staging-20260702-f986daa.zip`. It includes the Admin Students loading fix for the live `programs` table schema.
