...
Package: `lms-hostinger-staging-20260704-recording-lifecycle.zip`

Generated: 04 Jul 2026

Git revision at package time: `5a5cced`

## Includes

- Hostinger-ready `public_html` build files.
- SPA `.htaccess` routing and no-cache `index.html` behavior.
- Schedule Meeting lifecycle cleanup:
  - Upcoming
  - Needs Completion
  - Cancelled / Archived
- Recording workspace lifecycle:
  - Add Link
  - Pending Review
  - Published
  - Rejected
- Manual recording links now enter Pending Review before student visibility.
- Student visibility remains gated to published recording URLs only.
