...
export const studentNavItems: NavItem[] = [
  ...
  { label: 'ATS Resume Score', path: '/student/ats-resume-score', moduleId: 'ats-resume-score', icon: FileSearch, mode: 'write' },
  { label: 'Live Project Hub', path: '/student/projects', moduleId: 'projects', icon: BookOpen, mode: 'read-only' },
  { label: 'My Project Submissions', path: '/student/project-submissions', moduleId: 'project-submissions', icon: ClipboardCheck, mode: 'read-only' },
  { label: 'My Certificates', path: '/student/certificates', moduleId: 'certificates', icon: FileCheck2, mode: 'read-only' },
...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'ATS Resume Score', path: '/admin/ats-resume-score', moduleId: 'ats-resume-score', icon: FileSearch, mode: 'write' },
  ...
  { label: 'Email Marketing', path: '/admin/email-marketing', moduleId: 'email-marketing', icon: MailCheck, mode: 'write' },
