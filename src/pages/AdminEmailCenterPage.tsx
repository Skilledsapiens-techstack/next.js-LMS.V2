...
const phaseOptions: PhaseOption[] = [
  ...
  { key: 'certificate', label: 'Certificate', variables: ['student_name', 'student_email', 'certificate_id', 'certificate_type_label', 'certificate_download_url', 'verification_url', 'program', 'cohort', 'project_role', 'live_project_role'] },
...
const sampleVars: Record<string, string> = {
  ...
  certificate_type_label: 'Leadership Training Completion Certificate',
  ...
  live_project_role: 'Business Analyst',
